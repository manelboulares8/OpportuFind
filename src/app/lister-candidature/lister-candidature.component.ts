...
@Component({
  selector: 'app-lister-candidature',
  standalone: false,
  templateUrl: './lister-candidature.component.html',
  styleUrl: './lister-candidature.component.css'
})
export class ListerCandidatureComponent implements OnInit {
